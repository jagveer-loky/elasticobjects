...
public class CompareEOConfigsTest extends CompareConfigs {
    ...
    @Test
    public void fieldsEOTest()  {
        compare(SHEET, FIELD, ELASTIC_OBJECTS, TEST);
    }

    @Test
    public void fieldsXEOMain()  {
        compare(SHEET, FIELD, ACTIONS_XLSX, MAIN);
    }

    @Test
    public void fieldsCEOMain()  {
        compare(SHEET, FIELD, ACTIONS_CSV, MAIN);
    }

    @Test
    public void fieldDBMain()  {
        compare(SHEET, FIELD, ACTIONS_DB, MAIN);
    }

    @Test
    public void fieldHDBMain()  {
        compare(SHEET, FIELD, ACTIONS_HDB, MAIN);
    }

    @Test
    public void fieldHDBTest()  {
    ...
    public void modelsEOMain()  {
        compare(SHEET, MODEL, ELASTIC_OBJECTS, MAIN);
    }

    @Test
    public void modelsEOTest()  {
        compare(SHEET, MODEL, ELASTIC_OBJECTS, TEST);
    }

    @Test
    public void modelsXEOMain()  {
        compare(SHEET, MODEL, ACTIONS_XLSX, MAIN);
    }
    ...
    @Test
    public void modelHDBMain()  {
        compare(SHEET, MODEL, ACTIONS_HDB, MAIN);
    }

    @Test
    public void modelHDBTest()  {
    ...
    public void usersEOMain()  {
        compare(SHEET, USER, ELASTIC_OBJECTS, MAIN);
    }
