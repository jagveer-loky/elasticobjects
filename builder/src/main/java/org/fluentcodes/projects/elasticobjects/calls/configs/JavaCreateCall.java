...
public class JavaCreateCall extends CreateCall {
    ...
    private final static String FIELD_KEYS_STRIPPED = "fieldKeysStripped";
    ...
    public Object execute(EO eo) {
        ...
        for (final String naturalId: eo.keys()) {
            ...
            eoModel.set(fields.getFieldKeys(), FIELD_KEYS_STRIPPED);
