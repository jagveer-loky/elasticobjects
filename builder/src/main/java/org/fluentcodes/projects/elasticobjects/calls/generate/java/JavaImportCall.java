...
/*=>{}.*/
    ...
    public String execute(final EO eo) {
        if (!(eo.get() instanceof ModelBeanProperties)) {
            throw new EoException("Input must be instance of '" + ModelBeanProperties.class.getSimpleName() + "' but is '" + eo.get().getClass().getSimpleName() + "'");
        }
        ...
        for (String fieldModelKey: fieldModelSet) {
            ...
            if (!(eoFieldModel.get() instanceof ModelBeanProperties)) {
                throw new EoException("Input must be instance of '" + ModelBeanProperties.class.getSimpleName() + "' but is '" + eo.get().getClass().getSimpleName() + "'");
            }
