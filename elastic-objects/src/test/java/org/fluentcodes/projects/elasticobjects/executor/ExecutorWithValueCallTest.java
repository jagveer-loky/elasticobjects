...
public class ExecutorWithValueCallTest extends TestHelper {
    ...
    public void intValue1WithPathMapPathAndValue() throws Exception {
        final EO adapter = TestCallsProvider.executeExecutorValueCall(VC_INT_VALUE1, F_PATH, S_LEVEL0, F_MAP_PATH, S_LEVEL1, F_VALUE, S_STRING);
    ...
    public void intValue1WithMapPathAndValue() throws Exception {
        final EO eoInt1 = TestCallsProvider.executeExecutorValueCall(VC_INT_VALUE1, F_MAP_PATH, S_LEVEL0, F_VALUE, S_STRING);
    ...
    public void testItemWithPathPathAndValue_ignoresValue() throws Exception {
        final EO adapter = TestCallsProvider.executeExecutorValueCall(VC_TEST_ITEM, F_PATH, F_TEST_STRING, F_VALUE, S_STRING_OTHER);
    ...
    public void testItemWithPathPath() throws Exception {
        final EO adapter = TestCallsProvider.executeExecutorValueCall(VC_TEST_ITEM, F_PATH, F_TEST_STRING);
        Assert.assertEquals(S_STRING, adapter.get(F_TEST_STRING));
    }
    ...
    public void emptyWithBT() throws Exception {
        EO eoBT = TestCallsProvider
                .executeExecutorValueCall(VC_EMPTY, F_MAP_PATH, F_BASIC_TEST, F_VALUE, BTProvider.createString());
