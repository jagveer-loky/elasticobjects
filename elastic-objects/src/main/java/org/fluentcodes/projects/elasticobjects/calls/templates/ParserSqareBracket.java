...
public class ParserSqareBracket extends Parser {
    ...
    private static final String CLOSE_SEQUENCE = Parser.CREATE_CLOSE_SEQUENCE(START, STOP);

    public ParserSqareBracket(final String template) {
        super(template);
    }
