...
public class Parser {
     ...
     * @return
     */
    public static String replacePathValues(final String template, final EO eo) {
    ...
    void handle(EO eo, String callSequence, Indicators callIndicator, String finish, StringBuilder result) {
