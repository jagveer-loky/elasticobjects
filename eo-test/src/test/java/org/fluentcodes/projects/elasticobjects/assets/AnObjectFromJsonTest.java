...
public class AnObjectFromJsonTest {
    ...
    public void testSmall()  {
        ...
        Assertions.assertThat(eo.get(AnObject.MY_INTEGER)).isEqualTo((S_INTEGER));
    }
    ...
    public void scope_dev__ASubObjectJson__thenNoLog()  {
        ...
        Assertions.assertThat(eo.getLog()).isEmpty();
        Assert.assertEquals(INFO_COMPARE_FAILS, AnObject.class, eo.getModelClass());
        Assertions.assertThat(eo.get(AnObject.MY_A_SUB_OBJECT, AnObject.MY_STRING)).isEqualTo((S_STRING));
    }
}
