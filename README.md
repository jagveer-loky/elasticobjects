...
#### ModelConfig
The configuration entry contains a list of field names referencing to a field configuration. So field configurations can defined independent
