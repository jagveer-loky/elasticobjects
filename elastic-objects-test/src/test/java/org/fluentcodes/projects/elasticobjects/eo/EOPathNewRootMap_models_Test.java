...
public class EOPathNewRootMap_models_Test extends TestHelper {
    ...
    public void mapInteger_ok()  {
        EOTestHelper.map_ok(F_TEST_INTEGER, Integer.class);
    }

    @Test
    public void mapMap_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_MAP, Map.class);
    }

    @Test
    public void mapHasMap_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_MAP, HashMap.class);
    }


    @Test
    public void mapList_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_LIST, List.class);
    }

    @Test
    public void mapArrayList_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_LIST, ArrayList.class);
    }

    @Test
    public void mapBT_ok()  {
        EOTestHelper.map_ok(F_BASIC_TEST, BasicTest.class);
    }
