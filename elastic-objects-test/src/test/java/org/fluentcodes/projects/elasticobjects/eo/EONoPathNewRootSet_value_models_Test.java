...
public class EONoPathNewRootSet_value_models_Test extends TestHelper {
    ...
    public void withMapAndInteger_ok()  {
        EOTestHelper.setValueWins_ok(S_INTEGER, Map.class);
    }

    @Test
    public void withBTAndInteger_ok()  {
        EOTestHelper.setValueWins_ok(S_INTEGER, BasicTest.class);
    }

    @Test
    public void withIntegerAndInteger_ok()  {
        EOTestHelper.setValueWins_ok(S_INTEGER, Integer.class);
    }

    @Test
    public void withIntegerAndHashMap_ok()  {
        EOTestHelper.setValueWins_ok(new HashMap(), Integer.class);
    }

    @Test
    public void withListAndArrayList_ok()  {
        EOTestHelper.setValue_ok(new ArrayList(), List.class);
    }

    @Test
    public void withMapAndArrayList_ok()  {
        EOTestHelper.setValueWins_ok(new ArrayList(), Map.class);
    }

    @Test
    public void withMapAndHashMap_ok()  {
        EOTestHelper.setValue_ok(new HashMap(), Map.class);
    }

    @Test
    public void withBTAndBT_ok()  {
        EOTestHelper.setValue_ok(new BasicTest(), BasicTest.class);
    }

    @Test
    public void withBTAndMap_ok()  {
        EOTestHelper.setValueWins_ok(new BasicTest(), Map.class);
    }
