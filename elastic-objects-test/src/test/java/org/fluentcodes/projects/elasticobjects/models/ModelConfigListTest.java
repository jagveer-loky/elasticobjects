...
public class ModelConfigListTest {
    ...
    public void DEV_findModel_List__create__getClass_ArrayList()  {
        ModelConfigList listModel = (ModelConfigList) ProviderConfigMaps.CONFIG_MAPS_DEV.findModel(List.class);
    ...
    public void DEV_findModel_ArrayList__create__isList()  {
        ModelConfigList listModel = (ModelConfigList) ProviderConfigMaps.CONFIG_MAPS_DEV.findModel(ArrayList.class);
