...
public class EONoPathNewRootMap_value_models_Test {
    ...
    public void mapInteger_ok()  {
        EOTestHelper.mapValue_ok(S_INTEGER, Integer.class);
    }

    @Test
    public void mapInteger_withString_ok()  {
        EO root = EOTestHelper.mapValue_ok(S_INTEGER, String.class);
        Assert.assertEquals(INFO_COMPARE_FAILS, S_INTEGER.toString(), root.get());
    }

    @Test
    public void mapArrayList_ok()  {
        EOTestHelper.mapValue_ok(new ArrayList(), ArrayList.class);
    }

    @Test
    public void mapList_ok()  {
        EOTestHelper.mapValue_ok(new ArrayList(), List.class);
    }

    @Test
    public void mapMap_ok()  {
        EOTestHelper.mapValue_ok(new HashMap(), Map.class);
    }

    @Test
    public void mapHashMap_ok()  {
        EOTestHelper.mapValue_ok(new HashMap(), HashMap.class);
    }
    ...
    public void jsonMapEmptyList_ok()  {
        ...
        final EO listEO = TestEOProvider.create(jsonMapSmall);
    ...
    public void jsonMapEmptyBT_ok()  {
        ...
        final EO eoBTJson = TestEOProvider.create(jsonEmpty);
    ...
    public void jsonMapSmallBT_ok()  {
        ...
        final EO eoBTJsonSmall = TestEOProvider.create(jsonSmall);
    ...
    public void jsonListSmallBT_fails()  {
        ...
        final EO eoBTJsonListSmall = TestEOProvider.create(jsonListSmall);
    ...
    public void mapHashMapWithBT_ok()  {
        EOTestHelper.mapValue_ok(new HashMap(), BasicTest.class);
    }

    @Test
    public void mapBT_ok()  {
        EOTestHelper.mapValue_ok(new BasicTest(), BasicTest.class);
    }
    ...
    public void mapBTStringWithMap_ok()  {
        EO root = EOTestHelper.mapValue_ok(BTProvider.createString(), Map.class);
    ...
    public void jsnMapEmptyST_ok()  {
        ...
        final EO eoBTJson = TestEOProvider.create(jsnEmpty);
