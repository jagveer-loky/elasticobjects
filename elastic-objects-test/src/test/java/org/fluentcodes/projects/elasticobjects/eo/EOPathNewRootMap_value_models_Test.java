...
public class EOPathNewRootMap_value_models_Test {
    ...
    public void mapInteger_ok()  {
        EOTestHelper.map_ok(F_TEST_INTEGER, S_INTEGER, Integer.class);
    }

    @Test
    public void mapArrayList_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_LIST, new ArrayList(), ArrayList.class);
    }

    @Test
    public void mapList_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_LIST, new ArrayList(), List.class);
    }

    @Test
    public void mapMap_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_MAP, new HashMap(), Map.class);
    }

    @Test
    public void mapHashMap_ok()  {
        EOTestHelper.map_ok(F_UNTYPED_MAP, new HashMap(), HashMap.class);
    }

    @Test
    public void mapHashMapWithBT_ok()  {
        EOTestHelper.map_ok(F_BASIC_TEST, new HashMap(), BasicTest.class);
    }

    @Test
    public void mapBT_ok()  {
        EOTestHelper.map_ok(F_BASIC_TEST, new BasicTest(), BasicTest.class);
    }
