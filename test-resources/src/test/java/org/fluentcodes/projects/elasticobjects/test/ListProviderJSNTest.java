...
public class ListProviderJSNTest {

    @Test
    public void createEmpty() throws Exception {
        ListProviderJSN.createEmpty();
    }

    @Test
    public void compareEmpty() throws Exception {
        ListProviderJSN.compareEmpty();
    }

    @Test
    public void createString() throws Exception {
        ListProviderJSN.createString();
    }

    @Test
    public void compareString() throws Exception {
        ListProviderJSN.compareString();
    }
    ...
    public void createBT() throws Exception {
        ListProviderJSN.createBT();
    }

    @Test
    public void compareBT() throws Exception {
        ListProviderJSN.compareBT();
    }
    ...
    public void createSmall() throws Exception {
        ListProviderJSN.createSmall();
    }

    @Test
    public void compareSmall() throws Exception {
        ListProviderJSN.compareSmall();
    }

    @Test
    public void createEOSimple() throws Exception {
        ListProviderJSN.createSimple();
    }

    @Test
    public void compareEOSimple() throws Exception {
        ListProviderJSN.compareSimple();
    }

    @Test
    public void create() throws Exception {
        ListProviderJSN.create();
    }


    @Test
    public void compare() throws Exception {
        ListProviderJSN.compare();
    }
}
