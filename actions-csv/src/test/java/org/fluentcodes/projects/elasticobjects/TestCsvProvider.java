...
public class TestCsvProvider {
    public static CallExecutor createCallExecutorRead(final String key)  {
        return createCallExecutorRead(new HashMap(), key);
    }

    public static CallExecutor createCallExecutorRead(Map attributes, final String key)  {
    ...
    public static CallExecutor createCallExecutorWrite(final String key)  {
        return createCallExecutorWrite(new HashMap(), key);
    }

    public static CallExecutor createCallExecutorWrite(Map attributes, final String key)  {
